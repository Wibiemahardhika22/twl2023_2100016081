...
const AboutComponent = () => {
    return (
        <div className='flex items-center justify-center min-h-screen dark:bg-slate-900'>
            <div className="relative w-full group max-w-md min-w-0 mx-auto mt-6 mb-6 break-words bg-white border shadow-xl md:max-w-sm rounded-xl dark:bg-slate-800">
                <div className="pb-6">
                    ...
                    <div className="flex flex-wrap justify-center">
                        <div className="flex justify-center w-full">
                            <div className="relative">
                                <img src={Profile} className="border-white rounded-full align-middle border-8 absolute -m-16 -ml-23 max-w-[150px] dark:border-slate-800" />
                            </div>
                        </div>
                    </div>
                    {/* End Image */}
                    ...
                    <div className="mt-20 text-center">
                        <h3 className="mb-1 text-2xl font-bold leading-normal text-gray-700 dark:text-white">Wibie Mahardhika Adi</h3>
                        <div className="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                            <div className="mx-2 tracking-wide text-gray-600 text-xl dark:text-white">Mahasiswa</div>
                        </div>
                        ...
                        <div className="w-full text-center">
                            <div className="flex justify-center pt-8 pb-0 lg:pt-4">
                                <div className="flex space-x-2">
                                    <a
                                        className="p-1 -m-1 text-gray-400 hover:text-[#9089fc] focus:outline-none focus-visible:ring-2 ring-primary dark:text-white"
                                        href="https://wa.me/6285832630272"
                                        rel="noreferrer"
                                        aria-label="Twitter"
                                        target="_blank"
                                    >
                                        <svg className="w-6 h-6 overflow-visible fill-current" alt="" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                            <path
                                    ...
                                    <a
                                        className="p-1 -m-1 text-gray-400 hover:text-[#9089fc] focus:outline-none focus-visible:ring-2 ring-primary dark:text-white"
                                        href="https://www.github.com/wibiemahardhika22"
                                        rel="noreferrer"
                                        aria-label="Github"
                                        target="_blank">
                                    ...
                                    <a
                                        className="p-1 -m-1 text-gray-400 hover:text-[#9089fc] focus:outline-none focus-visible:ring-2 ring-primary dark:text-white"
                                        href="https://www.instagram.com/wibiemahardhika1"
                                        rel="noreferrer"
                    ...
                    <div className="pt-6 mx-6 mt-6 text-center border-t border-gray-200">
                        <div className="flex flex-wrap justify-center">
                            <div className="w-full px-6">
                                <p className="mb-4 font-light leading-relaxed text-gray-600 dark:text-white">
                                    Saya adalah mahasiswa yang sedang menempuh pendidikan di Universitas Ahmad Dahlan. Saya memiliki keinginan untuk memahami bagaimana teknologi dapat digunakan secara efektif untuk meningkatkan efisiensi dan kinerja suatu organisasi atau bisnis.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative h-6 overflow-hidden translate-y-6 rounded-b-xl">
                        <div className="absolute flex -space-x-12 rounded-b-2xl">
                            <div className="w-36 h-8 transition-colors duration-200 delay-75 transform skew-x-[35deg] bg-slate-400/90 group-hover:bg-slate-600/90 z-10"></div>
                            <div className="w-28 h-8 transition-colors duration-200 delay-100 transform skew-x-[35deg] bg-slate-300/90 group-hover:bg-slate-500/90 z-20"></div>
                            <div className="w-28 h-8 transition-colors duration-200 delay-150 transform skew-x-[35deg] bg-slate-200/90 group-hover:bg-slate-400/90 z-30"></div>
                            <div className="w-28 h-8 transition-colors duration-200 delay-200 transform skew-x-[35deg] bg-slate-100/90 group-hover:bg-slate-300/90 z-40"></div>
                            <div className="w-28 h-8 transition-colors duration-200 delay-300 transform skew-x-[35deg] bg-slate-50/90 group-hover:bg-slate-200/90 z-50"></div>
                        </div>
                    </div>
                </div>
            </div>
